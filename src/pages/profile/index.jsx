    ...
    <LayoutProfile title={"Profile"}>
        <div className={styles.container}>
          <div className={styles.profileBar}>
            <span onClick={()=>{
              setShowOrder(false)
            }} className={`${styles.span} ${showOrder ? "" : styles.act}`}>Account Settings</span>
            <span onClick={()=>{
              setShowOrder(true)
            }} className={`${styles.span} ${showOrder ? styles.act : ""}`}>Order History</span>
            <span className={`${styles.barActive} ${showOrder ? styles.order : ""}`}></span>
          </div>
          {showOrder ?
          <>
